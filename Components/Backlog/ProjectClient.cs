...
namespace Backlog
{
    public class ProjectClient : IProjectClient
    {
        ...
        private readonly Dictionary<long, ProjectInfo> _projectCache = new Dictionary<long, ProjectInfo>();
        ...
        public async Task<ProjectInfo> Get(long projectId) => 
            await new GetProjectCommand(projectId, DoGet, DoGetFromCache).ExecuteAsync();
